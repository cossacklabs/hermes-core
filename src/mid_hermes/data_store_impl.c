...
hermes_data_store_t* hermes_data_store_create(hm_rpc_transport_t* transport){
  ...
  if(!ds
     || !(ds->cl=hm_data_store_client_sync_create(transport))){
...
hermes_status_t hermes_data_store_set_block(hermes_data_store_t* ds,
  ...
  if(!ds || !data || !data_length || !meta || !meta_length || !mac || !mac_length || !id || !id_length){
    return HM_INVALID_PARAMETER;
  }
  if(!old_mac){
    if(!(*id)){
      return hm_data_store_client_sync_call_create_block(ds->cl,
                                                         data,
                                                         data_length,
                                                         meta,
                                                         meta_length,
    ...
    return hm_data_store_client_sync_call_create_block_with_id(ds->cl,
                                                               *id,
                                                               *id_length,
                                                               data,
                                                               data_length,
  ...
  return hm_data_store_client_sync_call_update_block(ds->cl,
                                                     *id,
                                                     *id_length,
                                                     data,
                                                     data_length,
...
hermes_status_t hermes_data_store_get_block(hermes_data_store_t* ds,
  ...
  return hm_data_store_client_sync_call_read_block(ds->cl,
                                                   id,
                                                   id_length,
                                                   data,
                                                   data_length,
...
hermes_status_t hermes_data_store_rem_block(hermes_data_store_t* ds,
  ...
  return hm_data_store_client_sync_call_delete_block(ds->cl, id, id_length, old_mac, old_mac_length);
}
...
hermes_status_t hermes_data_store_destroy(hermes_data_store_t** ds){
  ...
  hm_data_store_client_sync_destroy(&((*ds)->cl));
  free(*ds);
  *ds=NULL;
  return HM_SUCCESS;
}
