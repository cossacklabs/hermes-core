...
data_store_test: CMD = $(CC) -o $(TEST_BIN_PATH)/data_store_test $(DATA_STORE_TEST_OBJ) $(COMMON_TEST_OBJ) -L$(BIN_PATH)  $(LDFLAGS) -ldata_store -lrpc -lcommon -lsoter $(COVERLDFLAGS) -lpthread
...
test: rpc_test credential_store_test data_store_test key_store_test
